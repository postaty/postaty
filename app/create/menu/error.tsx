    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="bg-surface-1 border border-card-border rounded-2xl p-8 max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold mb-2">
          {t("فشل إنشاء القائمة", "Menu generation failed")}
        </h1>
        <p className="text-muted mb-6">
          {t(
            "حدث خطأ أثناء إنشاء القائمة. لم يتم خصم أي رصيد. يرجى المحاولة مرة أخرى.",
            "An error occurred during menu generation. No credit was charged. Please try again."
          )}
        </p>
